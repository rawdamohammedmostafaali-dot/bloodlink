...
class _UploadGovernoratesScreenState extends State<UploadGovernoratesScreen> {
  ...
  final List<Map<String, dynamic>> governorates = [
    {"name":"القاهرة","hospitals":["مستشفى القصر العيني","مستشفى الهلال الأحمر","مركز الدم الرئيسي"]},
    {"name":"الجيزة","hospitals":["مستشفى إمبابة العام","مستشفى أم المصريين","مركز الدم بالهرم"]},
    {"name":"الإسكندرية","hospitals":["مستشفى الإسكندرية العام","مستشفى قصر الشاطئ","مركز الدم الرئيسي بالإسكندرية"]},
  ];
