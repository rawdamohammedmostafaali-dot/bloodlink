...
class _DonationHistoryScreenState extends State<DonationHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("سجل التبرعات"), backgroundColor: Colors.orangeAccent),
      body: Column(
        children: [
          Padding(
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance.collection('donation_history').orderBy('date', descending: true).snapshots(),
              builder: (context, snapshot) {
                ...
                if (donations.isEmpty) return const Center(child: Text("لا يوجد نتائج"));
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        leading: CircleAvatar(
                          ...
                          child: Text(bloodType, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                        ),
                        title: Text(donorName, style: const TextStyle(fontWeight: FontWeight.bold)),
